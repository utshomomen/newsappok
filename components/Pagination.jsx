  ...
  if (pathname === "/search") {
    return (
      <div className="pagination">
        {page === 1 && (<button className="pagination__arrowPrev disabled"><SvgArrowLeft color={currentTheme === "dark" ? "#E2F8F0" : "#0f2f7f"} /><p className="dark:!text-slate-200">Previous page</p></button>)}
        {page > 1 && (<Link className="group" onClick={handleBackTop} href={`${pathname}${searchQuery}&page=${page - 1}`}><button className="pagination__arrowPrev"><SvgArrowLeft color={currentTheme === "dark" ? "#E2F8F0" : "#0f2f7f"} /><p className="dark:!text-slate-200">Previous page</p></button></Link>)}
        ...
        {page < total_pages && (<Link className="group" onClick={handleBackTop} href={`${pathname}${searchQuery}&page=${page + 1}`}><button className="pagination__arrowNext"><p className="dark:!text-slate-200">Next Page</p><SvgArrowRight color={currentTheme === "dark" ? "#E2F8F0" : "#0f2f7f"} /></button></Link>)}
    ...
    return (
      <div className="pagination">
        ...
        {page < total_pages && (<Link className="group" onClick={handleBackTop} href={`${pathname}?page=${page + 1}`}><button className="pagination__arrowNext"><p className="dark:!text-slate-200">Next Page</p><SvgArrowRight color={currentTheme === "dark" ? "#E2F8F0" : "#0f2f7f"} /></button></Link>)}
        {page === total_pages && (<button className="pagination__arrowNext disabled"><p className="dark:!text-slate-200">Trang tiếp theo</p><SvgArrowRight color={currentTheme === "dark" ? "#E2F8F0" : "#0f2f7f"} /></button>)}
      </div>
    );
  }
